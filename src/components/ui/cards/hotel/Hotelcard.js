...
export const HotelCard = () => {
  return (
    <Link href="/singlehotel">
      <div
        className={`px-3 py-3 ${style.hotel_card} grid grid-cols-xl-3 grid-cols-lg-3 grid-cols-md-3 grid-cols-1 gap-2 position-relative`}
      >
        <div
        ...
        <div className="col-span-2">
          ...
          <div className="d-flex align-items-start justify-content-between gap-2">
            {/* ----------------------left_Side-------------------- */}
            <div className="w-75">
              <div className="d-flex align-items-md-center align-items-start flex-md-row flex-column gap-2 my-3">
                <div
