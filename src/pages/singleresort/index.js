  ...
  return (
    <>
      ...
      <section className="my-4">
        <div className="container">
          <div
            className={` content-container px-3 border-radius-4 d-flex align-items-center gap-5 mb-2`}
          >
            <button
              className={`menuItem ${
      ...
      <section className="my-4">
        <div className="container">
          <div className="grid grid-cols-3 gap-2 my-2">
            ...
            <div className="border border-radius-4 h-370">
      ...
      <section className="my-4">
        <div className="container">
          <div className=" ">
            ...
            <div className="content-container px-3 py-4 grid grid-cols-5 gap-2 my-3">
